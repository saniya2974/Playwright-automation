...
def run():
    with sync_playwright() as p:
        ...
        #  Navigating to Challenge and Product Inventory
        ...
        #  Scroll to load all cards (up to 50 scrolls)
        ...
        #  Extracting product data from each card
